...
import UI from '../newUI/adminDashboard';
...
class ChangePasswordAdmin extends Component{
  ...
  close=()=>{
  return this.props.history.replace('/adminDashboard')
  }
...
export default (connect(mapStateToProps, mapDispatchToProps)(ChangePasswordAdmin));