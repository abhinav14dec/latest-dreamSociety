                ...
                <div className="wrapper">
                    ...
                    <nav id="sidebar" className="bg-dark inactive">
                        <div id="sidebar-content">
                            <Menu.Item className="text-center h1 mr-4 mt-4 mb-4"><Icon className='col' name="user" /><div className='col ml-2 pb-3 border border-white border-left-0 border-right-0 border-top-0' style={{ fontSize: "0.8rem" }}><Link to="/employeeDashboard">Employee Tasks</Link></div></Menu.Item>
                            <Menu.Item className="text-center h1 mr-4 mt-4 mb-4"><Icon className='col' name="user" /><div className='col ml-2 pb-3 border border-white border-left-0 border-right-0 border-top-0' style={{ fontSize: "0.8rem" }}><Link to="/employeeDashboard">Invoice Detail</Link></div></Menu.Item>
