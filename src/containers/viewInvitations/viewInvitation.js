    ...
    acceptInvitation=id=>{
        ...
        switch(pathname){
            case '/ownerDashboard/viewInvitations':
                this.props.history.push(`/ownerDashboard/societyEventCelebration/${id}`)
                break;
            
            case '/tenantDashboard/viewInvitations':
                this.props.history.push(`/tenantDashboard/societyEventCelebration/${id}`)
            break;
            default: 
        }
    }
    render() {
        return (
            <div>
                ...
                {this.props.invitationList && this.props.invitationList.length!==0?
                    ...
                    return(
                        <tbody key={item.eventId}>
                            <tr>
                                ...
                                <td>
                                    <Button color="success" className="mr-2" onClick={()=>this.acceptInvitation(item.eventId)}>Accept</Button>
...
export default connect(mapStateToProps,{getInvitationList})(ViewInvitation)