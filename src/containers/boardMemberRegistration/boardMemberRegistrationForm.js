...
class BoardMemberRegistrationForm extends Component {
  ...
  defaultPermanentAddressChange = e => {
    this.setState({
      defaultCurrentAddress: this.state.correspondenceAddress,
      ...
      this.props
        ...
        .catch(err => {
          this.setState({
            ...
            userNameServerError: err.response.data.messageUsernameErr,
  ...
  fetchSocietyId = ({ boardId }) => {
    if (boardId) {
      return boardId.map(item => {
        return (
          <option value={item.societyId} key={item.societyId}>
            {item.societyName}
          </option>
        );
      });
    ...
    let formData = (
      <div style={{ marginBottom: "20px" }}>
        ...
        <FormGroup>
          ...
          <div>{<span className="error">{this.state.errors.gender}</span>}</div>
        </FormGroup>
        <FormGroup>
          <Row md={12}>
            <Col md={6}>
            ...
            <Row md={12}>
              ...
              <Col md={3}>
                ...
                <Select
                  ...
                  onChange={this.onChangeCity.bind(this, "cityName", "cityId")}
                />
              </Col>
              <Col md={3}>
        ...
        <FormGroup style={{ paddingTop: "20px" }}>
          ...
          <FormGroup>
            <span style={{ fontWeight: "600" }}>
              Is Your Current address same as above?
            </span>
            <Input
              type="checkbox"
              onChange={this.sameAddress}
              name="isChecked"
              id="isChecked"
              className="ml-3"
            />
          </FormGroup>
          {this.state.currentAddressVisible ? (
            <FormGroup>
              ...
              <Input
                ...
                onChange={this.defaultCurrentAddress}
              />
            </FormGroup>
          ) : (
            ""
        ...
        <Button color="danger" onClick={this.route}>
          Cancel
        </Button>
      </div>
    );
