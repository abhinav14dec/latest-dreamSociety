...
state = {
  ...
  submit = e => {
    ...
    if (isValid) {
      ...
      this.props
        .AddEvent(eventType, eventName, eventOrganiser)
        .then(() => this.props.history.push("/superDashboard/display-event"))
        .catch(err =>
    ...
    let form1 = (
      <div>
        <form onSubmit={this.submit}>
          ...
          <button onClick={this.event} className="btn btn-danger">
            {" "}
            Cancel
          </button>
        </form>
