...
class TenantFacility extends Component {
  ...
  getDataUser = userFacilty => {
    ...
    userFacilty.data.facilitiesInUse.map(item => {
      ...
      return this.state.facilitiesUser.push({
        facilityDetailId,
        endDate,
        isActive: true
      });
          ...
          <tr key={item.facilityDetailId}>
            <td>
              <Input
                ...
                defaultChecked
                className="SelectAll"
                value={this.state.facilityDetailId}
      ...
      return getFacilityUser.data.facilitiesNotInUse.map(item => {
        return (
          <tr key={item.facilityDetailId}>
            ...
            <td>
              {item.monthlyRate
                ? item.monthlyRate + " Per Monthly Rate"
                : item.unitRate + " Per Unit Rate"}
            </td>
            <td>
              {" "}
              <Input
    ...
    let table =
      this.state.type === "deactivated" ? (
        <Table className="table table-bordered">
          ...
          <tbody>{this.getUserData(this.props.userFacilityReducer)}</tbody>
          <FormGroup>
            <td>
              <Button
                color="success"
                onClick={this.submitFacilityData.bind(
                  this,
        ...
        <Table className="table table-bordered">
          ...
          <tbody>{this.getActivatedData(this.props.userFacilityReducer)}</tbody>

          <FormGroup>
            <Button
              color="success"
              onClick={this.inUseSubmit.bind(this, this.state.facilitiesUser)}
            >
              Submit
            </Button>
          </FormGroup>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(
    { notInFacility, addUserFacility, getUserFacility, updateUserFacility },
    dispatch
  );
}
